...
rename_and_filter_fields as (
    ...
    select
        ...
        string_field_6 as us_cogs_usd,
        string_field_7 as us_fba_fee_usd,
        string_field_8 as us_storage_fee_usd,
        string_field_9 as us_returns_usd,
        string_field_10 as us_all_costs_except_commission_usd,
        string_field_11 as us_avg_revenue_per_sale_usd,
        string_field_12 as us_return_rate, -- skip string_field_13
        string_field_14 as ca_fulfillment_type,
        string_field_15 as ca_local_cogs_cad,
        string_field_16 as ca_local_fba_fee_cad,
        string_field_17 as ca_local_storage_fee_cad,
        string_field_18 as ca_local_returns_cad,
        string_field_19 as ca_local_all_costs_except_commission_cad,
        string_field_20 as ca_local_avg_revenue_per_sale_cad,
        string_field_21 as ca_local_return_rate,
        string_field_22 as ca_narf_cogs_cad,
        string_field_23 as ca_narf_fba_fee_cad,
        string_field_24 as ca_narf_storage_fee_cad,
        string_field_25 as ca_narf_returns_cad,
        string_field_26 as ca_narf_all_costs_except_commission_cad,
        string_field_27 as ca_narf_avg_revenue_per_sale_cad,
        string_field_28 as ca_narf_return_rate, -- skip string_field_29
        string_field_30 as uk_cogs_gbp,
        string_field_31 as uk_fba_fee_gbp,
        string_field_32 as uk_storage_fee_gbp,
        string_field_33 as uk_returns_gbp,
        string_field_34 as uk_all_costs_except_commission_gbp,
        string_field_35 as uk_avg_revenue_per_sale_gbp,
