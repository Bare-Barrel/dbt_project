-- stg_brand_analytics__search_query_performance_asin_view.sql

with

search_query_performance_asin_view as (

    select * from {{ source('brand_analytics','search_query_performance_asin_view') }}
