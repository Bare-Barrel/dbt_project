-- stg_business_reports__detail_page_sales_and_traffic_parent.sql

with

detail_page_sales_and_traffic_parent as (

    select * from {{ source('business_reports','detail_page_sales_and_traffic_parent') }}
...
rename_fields as (
    ...
    from detail_page_sales_and_traffic_parent
